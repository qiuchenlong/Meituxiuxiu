package com.meituxiuxiu.android.cropimage;
...
//		canvas.clipRect(mDrawableFloat, Op.DIFFERENCE); // Region.Op.DIFFERENCE
//		// 在交集的补集上画上灰色用来区分
...
//		
//		float mW=(float) ((mDrawableFloat.right-mDrawableFloat.left)/3.0f);
//		float mH=(float) ((mDrawableFloat.bottom-mDrawableFloat.top)/3.0f);
//		
//		Log.e("TAG", "top="+mDrawableFloat.top);
//		Log.e("TAG", "bottom="+mDrawableFloat.bottom);
//		
//		Log.e("TAG", "mW="+mW);
//		Log.e("TAG", "mH="+mH);
//		
...
//		
//		/**画辅助线*/
//		canvas.drawLine(mDrawableFloat.left, mDrawableFloat.top+mH, mDrawableFloat.right, mDrawableFloat.top+mH, paint);
//		canvas.drawLine(mDrawableFloat.left, mDrawableFloat.top+mH*2, mDrawableFloat.right, mDrawableFloat.top+mH*2, paint);
//		
//		canvas.drawLine(mDrawableFloat.left+mW, mDrawableFloat.top, mDrawableFloat.left+mW, mDrawableFloat.bottom, paint);
//		canvas.drawLine(mDrawableFloat.left+mW*2, mDrawableFloat.top, mDrawableFloat.left+mW*2, mDrawableFloat.bottom, paint);
//		
//		/**画辅助框（不包含四个角）*/
//		// top
//		Bitmap hBmp = BitmapFactory.decodeResource(getResources(), R.drawable.crop_button_h);
//		canvas.drawBitmap(hBmp, mDrawableFloat.left+(int)mW*3/2-hBmp.getWidth()/2, mDrawableFloat.top-hBmp.getHeight()/2, paint);
//		// bottom
//		canvas.drawBitmap(hBmp, mDrawableFloat.left+(int)mW*3/2-hBmp.getWidth()/2, mDrawableFloat.bottom-hBmp.getHeight()/2, paint);
//		// left
//		Bitmap vBmp = BitmapFactory.decodeResource(getResources(), R.drawable.crop_button_v);
//		canvas.drawBitmap(vBmp, mDrawableFloat.left-vBmp.getWidth()/2, mDrawableFloat.top+(int)mH*3/2-vBmp.getHeight()/2, paint);
//		// right
//		canvas.drawBitmap(vBmp, mDrawableFloat.right-vBmp.getWidth()/2, mDrawableFloat.top+(int)mH*3/2-vBmp.getHeight()/2, paint);
	}
...
//		if(mDrawableFloat.left > mDrawableFloat.right-150){ // 移动时，左右即将交换了
//			isChange = true;
//		}
//		
//		if(mDrawableFloat.top > mDrawableFloat.bottom-150){ // 移动时，上下即将交换了
//			isChange = true;
//		}
